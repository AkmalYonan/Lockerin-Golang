...
func EnableCORS(w http.ResponseWriter) {
	...
	w.Header().Set("Access-Control-Allow-Headers", "Content-Type, Authorization, X-Requested-With, X-CSRF-Token, X-XSRF-Token, X-Request-ID, X-Device-Secret, Accept, Origin")
}
